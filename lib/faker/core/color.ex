defmodule Faker.Core.Color do
  ...
  def hex_color() do
    hex_code =
      Number.number_between(1, 16_777_215)
      |> Number.dec_to_hex()
  ...
  def rgb_color_as_array() do
    ...
    [
      String.slice(color, 1, 2) |> Number.hex_to_dec(),
      String.slice(color, 3, 2) |> Number.hex_to_dec(),
      String.slice(color, 5, 2) |> Number.hex_to_dec()
    ]
  end
  ...
  def rgb_css_color() do
    ...
    css_color = Number.random_float(1, 0, 1) |> Float.to_string()
  ...
  ## Examples
    iex> Faker.Core.Color.safe_color_name
        "rgba(0,255,122,0.8)""
  """
  def safe_color_name(), do: Helper.random_element(@safe_color_names)
  ...
  ## Examples
    iex> Faker.Core.Color.rgb_css_color
        "navajo_white"
  """
  def color_name(), do: Helper.random_element(@all_color_names)
  ...
  def hsl_color_as_array() do
    [
      Number.number_between(0, 360),
      Number.number_between(0, 100),
      Number.number_between(0, 100)
    ]
  end
